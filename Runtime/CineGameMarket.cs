...
namespace CineGame.SDK
{
	public class CineGameMarket
    {
        ...
        public static Dictionary<string, string> APIs = new Dictionary<string, string>
        {
            ...
            { Markets.CineGame_Filmstaden_SE, "https://filmstaden-se.cinegamecore.eu-1.cinemataztic.com/api/" },
            ...
            { Markets.KinoSpill_MDN_NO, "https://kinospill-no.cinegamecore.drf-1.cinemataztic.com/api/" },
